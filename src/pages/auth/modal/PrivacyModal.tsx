          ...
          <div className="space-y-6 text-dark-300">
            ...
            <div>
              ...
              <ul className="text-sm leading-relaxed space-y-2 list-disc list-inside ml-2">
                ...
                <li>
                  <strong>마케팅 및 광고:</strong> 신규 서비스 개발 및 맞춤 서비스 제공, 이벤트 정보
                  제공
                </li>
                <li>
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">2. 수집하는 개인정보 항목</h3>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ...
                동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다. 회원 탈퇴 시 즉시
                파기하며, 관련 법령에 따라 일정 기간 보관이 필요한 경우 해당 기간 동안 보관합니다.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">5. 개인정보 처리의 위탁</h3>
              <p className="text-sm leading-relaxed">
                회사는 서비스 향상을 위해 필요한 경우 개인정보 처리업무를 외부 전문업체에 위탁할 수
                있으며, 이 경우 위탁받은 업체가 개인정보보호법에 따라 개인정보를 안전하게 처리하도록
