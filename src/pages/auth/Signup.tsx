    ...
    <div className="flex h-screen w-screen overflow-hidden bg-black relative p-8">
      ...
      <div className="relative flex-1 bg-gradient-to-br p-8 flex flex-col justify-between rounded-2xl mr-4">
        <div>
          ...
          {/* Description */}
          <p className="text-xl text-white/90 leading-relaxed">기존 HTS의 불편함을 없애고</p>
      ...
      <div className="w-[700px] bg-[#1a1a1a]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-black/50 p-10 flex flex-col justify-center overflow-y-auto">
        <div>
