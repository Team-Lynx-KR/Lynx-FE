    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-[#1a1a1a] rounded-2xl w-full max-w-2xl max-h-[80vh] p-10 relative flex flex-col border border-dark-700 shadow-2xl">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-3xl font-bold text-white">LYNX 이용약관</h2>
        </div>

        {/* Effective Date */}
        <p className="text-sm text-dark-500 mb-8">시행일: 2026년 2월 1일</p>
          ...
          <div className="space-y-6 text-dark-300">
            <div>
              ...
              <p className="text-sm leading-relaxed">
                이 약관은 LYNX(이하 "회사")가 제공하는 AI 기반 주식 거래 플랫폼 서비스의 이용과
                관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 서비스 이용 조건 및 절차 등에
            ...
            <div>
              ...
              <ul className="text-sm leading-relaxed space-y-2 list-disc list-inside">
                <li>
                  "서비스"란 회사가 제공하는 AI 기반 주식 분석 및 거래 지원 플랫폼을 의미합니다.
                </li>
                <li>
                  "이용자"란 본 약관에 동의하고 회사가 제공하는 서비스를 이용하는 회원 및 비회원을
                  의미합니다.
                </li>
                <li>
                ...
                <li>"API Key"란 증권사와의 연동을 위한 인증 정보를 의미합니다.</li>
              </ul>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-white mb-2">제3조 (약관의 게시와 개정)</h3>
            ...
            <div>
              ...
              <ul className="text-sm leading-relaxed space-y-2">
                ...
                <li>
                  4. 기타 회사가 추가 개발하거나 제휴계약 등을 통해 이용자에게 제공하는 일체의
                  서비스
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">제5조 (서비스의 중단)</h3>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">제6조 (회원가입)</h3>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">제7조 (개인정보보호)</h3>
              <p className="text-sm leading-relaxed">
